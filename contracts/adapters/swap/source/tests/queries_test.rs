...
use skip_go_swap_adapter_swap_source::contract::{instantiate, query};
use skip_go_swap_adapter_swap_source::error::ContractError;
use skip_go_swap_adapter_swap_source::msg::InstantiateMsg;
use skip_go_swap_adapter_swap_source::swap_source;
use std::str::FromStr;
...
struct TestCase {
    ...
    expected_router_input: swap_source::QueryMsg,
    // what the router will reply back
    swap_source_router_resp: Binary,
...
impl TestCase {
    fn new(
        ...
        Self {
            ...
            swap_source_router_resp: to_json_binary(&router_response).unwrap(),
        ...
        let querier = move |msg: &WasmQuery| -> QuerierResult {
            match msg {
                WasmQuery::Smart { contract_addr, msg } => {
                    ...
                    let msg = from_json::<swap_source::QueryMsg>(msg)
                    ...
                    QuerierResult::Ok(ContractResult::Ok(self.swap_source_router_resp.clone()))
                }
...
fn tests() {
    let tests = vec![
        TestCase::new(
            ...
            swap_source::QueryMsg::SimulateSwapExactAmountInWithHops {
            ...
            swap_source::QuerySimulateSwapExactAmountInWithHopsResponse {
        ...
        TestCase::new(
            ...
            swap_source::QueryMsg::SimulateSwapExactAmountOutWithHops {
            ...
            swap_source::QuerySimulateSwapExactAmountOutWithHopsResponse {
