...
use dezswap::{
    asset::{Asset as DezswapAsset, AssetInfo},
    pair::{Cw20HookMsg as DezswapPairCw20HookMsg, ExecuteMsg as DezswapPairExecuteMsg},
};
use skip::swap::{ExecuteMsg, SwapOperation};
use skip_go_swap_adapter_dezswap::error::{ContractError, ContractResult};
...
#[test_case(
    Params {
        ...
        contract_balance: vec![Coin::new(100, "axpla")],
        swap_operation: SwapOperation {
                pool: "pool_1".to_string(),
                denom_in: "axpla".to_string(),
        ...
        expected_message: Some(SubMsg {
                ...
                msg: WasmMsg::Execute {
                    ...
                    msg: to_json_binary(&DezswapPairExecuteMsg::Swap {
                        offer_asset: DezswapAsset {
...
#[test_case(
    Params {
        ...
        expected_message: Some(SubMsg {
            id: 0,
            msg: WasmMsg::Execute {
                contract_addr: "xpla123".to_string(),
                msg: to_json_binary(&Cw20ExecuteMsg::Send {
                    contract: "pool_1".to_string(),
                    amount: Uint128::from(100u128),
                    msg: to_json_binary(&DezswapPairCw20HookMsg::Swap {
                        belief_price: None,
                        max_spread: Some(Decimal::percent(50)),
                        to: None,
                        deadline: None,
...
fn test_execute_dezswap_pool_swap(params: Params) -> ContractResult<()> {
    ...
    // Call execute_dezswap_pool_swap with the given test parameters
    let res = skip_go_swap_adapter_dezswap::contract::execute(
        deps.as_mut(),
        env,
        info,
        ExecuteMsg::DezswapPoolSwap {
