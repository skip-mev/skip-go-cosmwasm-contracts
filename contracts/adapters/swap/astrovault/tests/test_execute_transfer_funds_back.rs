use cosmwasm_std::{
    ...
    to_json_binary, Addr, BankMsg, Coin, QuerierResult,
    ReplyOn::Never,
    SubMsg, SystemResult, Uint128, WasmQuery,
};
        ...
        expected_messages: vec![
            ...
            SubMsg {
                ...
                msg: cosmwasm_std::CosmosMsg::Wasm(cosmwasm_std::WasmMsg::Execute {
                    contract_addr: "astrovault_cashback".to_string(),
                    msg: to_json_binary(&cw20::Cw20ExecuteMsg::Transfer {
                        recipient: "astrovault_router".to_string(),
...
fn test_execute_transfer_funds_back(params: Params) -> ContractResult<()> {
    ...
    let wasm_handler = move |query: &WasmQuery| -> QuerierResult {
        match query {
            WasmQuery::Smart { contract_addr, .. } => {
                if contract_addr == "astrovault_cashback" {
    ...
    ASTROVAULT_CASHBACK_ADDRESS.save(
        deps.as_mut().storage,
        &Addr::unchecked("astrovault_cashback"),
    )?;
