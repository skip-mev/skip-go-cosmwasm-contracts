...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _CONTRACTINFO.fields_by_name['extension']._serialized_options = b'\xca\xb4-\x15ContractInfoExtension'
